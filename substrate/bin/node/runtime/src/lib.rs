...
// 	traits::{ConstBool, ConstU128, ConstU16, ConstU32, ConstU64, Contains, EqualPrivilegeOnly, Get, KeyOwnerProofSystem, OnUnbalanced, Randomness},
...
// };
// // use pallet_asset_conversion::NativeOrWithId;
...
// 	traits::{AccountIdLookup, BlakeTwo256, Block as BlockT, IdentifyAccount, NumberFor, One, StaticLookup, Verify},
// 	transaction_validity::{TransactionSource, TransactionValidity},
// 	ApplyExtrinsicResult, FixedPointNumber, FixedU128, MultiSignature, MultiSigner, Percent, Perbill, Permill, Perquintill, RuntimeDebug,
// };
// use sp_std::prelude::*;
...
// 	traits::{Currency, Imbalance, LockIdentifier, WithdrawReasons},
// 	weights::{
...
// Copyright (C) Caerulean Bytechains Private Limited
// SPDX-License-Identifier: Apache-2.0
...
//! The CBC-Chain runtime. This can be compiled with `#[no_std]`, ready for Wasm.
...
pub use node_primitives::{AccountId, Signature};
use node_primitives::{AccountIndex, Balance, BlockNumber, Moment};
...
/// Runtime version.
pub const VERSION: RuntimeVersion = RuntimeVersion {
	spec_name: create_runtime_str!("cbc"),
	impl_name: create_runtime_str!("cbc-node"),
	authoring_version: 1,
	spec_version: 1,
	impl_version: 1,
...
/// Executive: handles dispatch of the various extrinsic origins.
pub type Executive = frame_executive::Executive<
	Runtime,
	Block,
	frame_system::ChainContext<Runtime>,
...
impl frame_system::Config for Runtime {
	...
	type Version = Version;
	/// Converts a module to the index of this module in the runtime.
...
impl pallet_timestamp::Config for Runtime {
	...
	type Moment = u64;
	/// OnTimestampSet is called when the timestamp is set in the runtime.
	type OnTimestampSet = ();
	/// Minimum period between blocks. Currently set to 1 second.
...
impl pallet_balances::Config for Runtime {
	...
	/// The maximum number of holds that can exist on an account.
	type MaxFreezes = frame_support::traits::ConstU32<0>;
	/// The maximum number of individual freezes that can exist on an account.
	type MaxIndividualFreeze = frame_support::traits::ConstU32<50>;
	/// The identifier used for holds.
	type HoldIdentifier = ();
	/// The identifier used for freezes.
	type FreezeIdentifier = ();
	/// The identifier used for locks.
	type LockIdentifier = ();
	/// The identifier used for slashes.
	type SlashIdentifier = ();
	/// The maximum number of holds that can exist on an account.
	type MaxHolds = frame_support::traits::ConstU32<0>;
	/// The identifier used for reserves.
	type ReserveIdentifier = [u8; 8];
}
